...
const faqData = [
  // SHIPPING POLICY - USA
  {
    ...
    answer:
      "We offer free standard shipping (5-7 business days) on orders over $50. Express shipping (2-3 business days) is available for $9.99, and next-day shipping is $19.99.",
    region: "USA",
  },
  {
    category: "Shipping",
  ...
  // SHIPPING POLICY - India
  {
    ...
    answer:
      "We offer free standard shipping (5-8 business days) on orders over ₹2,000. Express shipping (2-4 business days) is available for ₹299. We ship via reliable courier partners like Blue Dart and Delhivery.",
    region: "India",
  },
  {
    category: "Shipping",
  ...
  // SHIPPING POLICY - Japan
  {
    ...
    answer:
      "We offer free standard shipping (3-5 business days) on orders over ¥5,000. Express shipping (1-2 business days) is available for ¥800. We use Japan Post and Yamato Transport.",
    region: "Japan",
  },
  ...
  // SHIPPING POLICY - China
  {
    ...
    answer:
      "We offer free standard shipping (4-7 business days) on orders over ¥200. Express shipping (2-3 business days) is available for ¥50. We use SF Express and China Post.",
    region: "China",
  },
  ...
  // RETURN POLICY - USA
  {
    ...
    answer:
      "We accept returns within 30 days of delivery. Items must be unopened and in original packaging. Refunds are processed within 5-7 business days. Return shipping is free for defective items; otherwise, customers pay return shipping.",
    region: "USA",
  },
  {
    category: "Returns",
    ...
    answer:
      "Contact our support team via chat or email with your order number. We'll send you a prepaid return label if the item is defective. For non-defective returns, you can use any shipping carrier.",
    region: "USA",
  },
  ...
  // RETURN POLICY - India
  {
    ...
    answer:
      "We accept returns within 15 days of delivery. Items must be unopened with original packaging and tags. Refunds are processed to the original payment method within 7-10 business days. Return pickup is free for defective items.",
    region: "India",
  },
  ...
  // RETURN POLICY - Japan
  {
    ...
    answer:
      "We accept returns within 14 days of delivery. Items must be unopened and unused. Refunds are processed within 7 business days. Return shipping costs are covered by us for defective products.",
    region: "Japan",
  },
  ...
  // RETURN POLICY - China
  {
    ...
    answer:
      "We accept returns within 7 days per Chinese consumer protection laws. Items must be unused with all accessories. Refunds are processed within 7-15 business days after we receive the returned item.",
    region: "China",
  },
  ...
  // SUPPORT HOURS - USA
  {
    ...
    answer:
      "Our US support team is available Monday-Friday 9 AM - 6 PM EST, and Saturday 10 AM - 4 PM EST. You can reach us via live chat, email (support@gamerhub.com), or phone at 1-800-GAMER-HQ.",
    region: "USA",
  },
  ...
  // PAYMENT METHODS - USA
  {
    ...
    answer:
      "We accept Visa, Mastercard, American Express, Discover, PayPal, Apple Pay, Google Pay, and Affirm for installment payments. All transactions are in USD and secured with 256-bit SSL encryption.",
    region: "USA",
  },
  ...
  // PAYMENT METHODS - India
  {
    ...
    answer:
      "We accept Credit/Debit Cards (Visa, Mastercard, RuPay), UPI (GPay, PhonePe, Paytm), Net Banking, Wallets (Paytm, PhonePe), and Cash on Delivery (COD) for orders under ₹50,000. Payments are in INR via Razorpay.",
    region: "India",
  },
  ...
  // PAYMENT METHODS - Japan
  {
    ...
    answer:
      "We accept Credit Cards (JCB, Visa, Mastercard), Konbini payments (FamilyMart, 7-Eleven, Lawson), PayPay, and bank transfers. All transactions are in JPY.",
    region: "Japan",
  },
  ...
  // PAYMENT METHODS - China
  {
    ...
    answer:
      "We accept Alipay, WeChat Pay, UnionPay, and major credit cards. All transactions are in CNY and comply with Chinese payment regulations.",
    region: "China",
  },
  ...
  },
  {
    ...
    answer:
      "Contact our support team with your order number and issue description. For manufacturing defects, we'll arrange free replacement or repair. Keep your invoice and original packaging for warranty claims.",
    region: null,
  },
  ...
  // DISCOUNTS AND OFFERS
  {
    ...
    answer:
      "Yes! We run regular promotions and sales events. Sign up for our newsletter to receive exclusive discount codes. We also offer student discounts (10% off) and loyalty rewards for repeat customers.",
    region: null,
  },
